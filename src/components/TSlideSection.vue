    ...
    <div class="slide-container">
        ...
        <div class="box-container">
            <section class="box slide">
                <div class="slide-content" @click="this.$router.push('/cenik')">
                    <div class="img-container">
                        <img src="/img/wedding1.jpg" alt="wedding" loading="lazy">
                    </div>
            ...
            <section class="box slide">
                <div class="slide-content" @click="this.$router.push('/cenik')">
                    <div class="img-container">
                        <img src="/img/couple1.jpg" alt="couple" loading="lazy">
                    </div>
                    <h3>Párové focení</h3>
            ...
            <section class="box slide">
                <div class="slide-content" @click="this.$router.push('/cenik')">
                    <div class="img-container">
                        <img src="/img/nature1.jpg" alt="nature" loading="lazy">
                    </div>
            ...
            <section class="box slide">
                <div class="slide-content" @click="this.$router.push('/cenik')">
                    <div class="img-container">
                        <img src="/img/janek1.jpg" alt="pregnant" loading="lazy">
                    </div>
